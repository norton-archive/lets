...
<pre>ets_opt() = set | ordered_set | named_table | {keypos, pos_integer()} | public | protected | private | compressed | async</pre>
...
<pre>lets_tab() = <a href="gen_ets_ns.md#type-gen_tab">gen_ets_ns:gen_tab()</a></pre>
...
<pre>lets_tid() = <a href="gen_ets_ns.md#type-gen_tid">gen_ets_ns:gen_tid()</a></pre>
...
<pre>match_pattern() = <a href="gen_ets_ns.md#type-match_pattern">gen_ets_ns:match_pattern()</a></pre>
...
<pre>match_spec() = <a href="gen_ets_ns.md#type-match_spec">gen_ets_ns:match_spec()</a></pre>
...
<pre>name() = <a href="gen_ets_ns.md#type-gen_name">gen_ets_ns:gen_name()</a></pre>
...
<pre>all() -> [<a href="#type-lets_tab">lets_tab()</a>]</pre>
<br></br>
...
<pre>delete(Tab::<a href="#type-lets_tab">lets_tab()</a>) -> true</pre>
<br></br>
...
<pre>delete(Tab::<a href="#type-lets_tab">lets_tab()</a>, Key::<a href="#type-key">key()</a>) -> true</pre>
<br></br>
...
<pre>delete_all_objects(Tab::<a href="#type-lets_tab">lets_tab()</a>) -> true</pre>
<br></br>
...
<pre>first(Tab::<a href="#type-lets_tab">lets_tab()</a>) -> <a href="#type-key">key()</a> | '$end_of_table'</pre>
<br></br>
...
<pre>foldl(Fun, Acc0::term(), Tab::<a href="#type-lets_tab">lets_tab()</a>) -> Acc1::term()</pre>
...
<pre>foldr(Fun, Acc0::term(), Tab::<a href="#type-lets_tab">lets_tab()</a>) -> Acc1::term()</pre>
<ul class="definitions"><li><pre>Fun = fun((Element::term(), AccIn::term()) -&gt; AccOut::term())</pre></li></ul>
...
<pre>info(Tab::<a href="#type-lets_tab">lets_tab()</a>) -> [{<a href="#type-item">item()</a>, term()}]</pre>
<br></br>
...
<pre>info(Tab::<a href="#type-lets_tab">lets_tab()</a>, Item::<a href="#type-item">item()</a>) -> term()</pre>
<br></br>
...
<pre>insert(Tab::<a href="#type-lets_tab">lets_tab()</a>, ObjOrObjs::<a href="#type-object">object()</a> | [<a href="#type-object">object()</a>]) -> true</pre>
<br></br>
...
<pre>insert_new(Tab::<a href="#type-lets_tab">lets_tab()</a>, ObjOrObjs::<a href="#type-object">object()</a> | [<a href="#type-object">object()</a>]) -> true</pre>
<br></br>
...
<pre>last(Tab::<a href="#type-lets_tab">lets_tab()</a>) -> <a href="#type-key">key()</a> | '$end_of_table'</pre>
<br></br>
...
<pre>lookup(Tab::<a href="#type-lets_tab">lets_tab()</a>, Key::<a href="#type-key">key()</a>) -> [<a href="#type-object">object()</a>]</pre>
<br></br>
...
<pre>lookup_element(Tab::<a href="#type-lets_tab">lets_tab()</a>, Key::<a href="#type-key">key()</a>, Pos::<a href="#type-pos">pos()</a>) -> term()</pre>
<br></br>
...
<pre>match(Tab::<a href="#type-lets_tab">lets_tab()</a>, Pattern::<a href="#type-match_pattern">match_pattern()</a>) -> [<a href="#type-match">match()</a>]</pre>
<br></br>
...
<pre>match(Tab::<a href="#type-lets_tab">lets_tab()</a>, Pattern::<a href="#type-match_pattern">match_pattern()</a>, Limit::<a href="#type-limit">limit()</a>) -> {[<a href="#type-match">match()</a>], <a href="#type-cont">cont()</a> | '$end_of_table'} | '$end_of_table'</pre>
<br></br>
...
<pre>match_delete(Tab::<a href="#type-lets_tab">lets_tab()</a>, Pattern::<a href="#type-match_pattern">match_pattern()</a>) -> true</pre>
<br></br>
...
<pre>match_object(Tab::<a href="#type-lets_tab">lets_tab()</a>, Pattern::<a href="#type-match_pattern">match_pattern()</a>) -> [<a href="#type-match">match()</a>]</pre>
<br></br>
...
<pre>match_object(Tab::<a href="#type-lets_tab">lets_tab()</a>, Pattern::<a href="#type-match_pattern">match_pattern()</a>, Limit::<a href="#type-limit">limit()</a>) -> {[<a href="#type-match">match()</a>], <a href="#type-cont">cont()</a> | '$end_of_table'} | '$end_of_table'</pre>
<br></br>
...
<pre>member(Tab::<a href="#type-lets_tab">lets_tab()</a>, Key::<a href="#type-key">key()</a>) -> true | false</pre>
<br></br>
...
<pre>new(Name::<a href="#type-name">name()</a>, Opts::<a href="#type-opts">opts()</a>) -> <a href="#type-lets_tab">lets_tab()</a></pre>
<br></br>
...
<pre>next(Tab::<a href="#type-lets_tab">lets_tab()</a>, Key::<a href="#type-key">key()</a>) -> <a href="#type-key">key()</a> | '$end_of_table'</pre>
<br></br>
...
<pre>prev(Tab::<a href="#type-lets_tab">lets_tab()</a>, Key::<a href="#type-key">key()</a>) -> <a href="#type-key">key()</a> | '$end_of_table'</pre>
<br></br>
...
<pre>select(Tab::<a href="#type-lets_tab">lets_tab()</a>, Spec::<a href="#type-match_spec">match_spec()</a>) -> [<a href="#type-match">match()</a>]</pre>
<br></br>
...
<pre>select(Tab::<a href="#type-lets_tab">lets_tab()</a>, Spec::<a href="#type-match_spec">match_spec()</a>, Limit::<a href="#type-limit">limit()</a>) -> {[<a href="#type-match">match()</a>], <a href="#type-cont">cont()</a> | '$end_of_table'} | '$end_of_table'</pre>
<br></br>
...
<pre>select_count(Tab::<a href="#type-lets_tab">lets_tab()</a>, Spec::<a href="#type-match_spec">match_spec()</a>) -> pos_integer()</pre>
<br></br>
...
<pre>select_delete(Tab::<a href="#type-lets_tab">lets_tab()</a>, Spec::<a href="#type-match_spec">match_spec()</a>) -> pos_integer()</pre>
<br></br>
...
<pre>select_reverse(Tab::<a href="#type-lets_tab">lets_tab()</a>, Spec::<a href="#type-match_spec">match_spec()</a>) -> [<a href="#type-match">match()</a>]</pre>
<br></br>
...
<pre>select_reverse(Tab::<a href="#type-lets_tab">lets_tab()</a>, Spec::<a href="#type-match_spec">match_spec()</a>, Limit::<a href="#type-limit">limit()</a>) -> {[<a href="#type-match">match()</a>], <a href="#type-cont">cont()</a> | '$end_of_table'} | '$end_of_table'</pre>
<br></br>
...
<pre>tab2list(Tab::<a href="#type-lets_tab">lets_tab()</a>) -> [<a href="#type-object">object()</a>]</pre>
<br></br>
...
<pre>tid(Tab::<a href="#type-lets_tab">lets_tab()</a>) -> <a href="#type-lets_tid">lets_tid()</a></pre>
<br></br>
